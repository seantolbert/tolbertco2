      ...
      <div className="px-5 w-full lg:w-2/3">
        ...
        <div className="flex items-center gap-9 py-10 lg:pl-16">
          <a
            ...
            className="group"
            >
            <FontAwesomeIcon icon={faLinkedin} size="2xl" className="group-hover:text-green-300 transition duration-150"/>
          </a>
          <a
            rel="noopener noreferrer"
            target="_blank"
            ...
            className="group"
            >
            <FontAwesomeIcon icon={faGithub} size="2xl" className="group-hover:text-green-300 transition duration-150"/>
          </a>
          <a
            rel="noopener noreferrer"
            target="_blank"
            ...
            className="group"
          >
            <FontAwesomeIcon icon={faCodepen} size="2xl" className="group-hover:text-green-300 transition duration-150"/>
          </a>
        </div>
